...
urlpatterns = [
    ...
    url(r'^get_dependencies/(?P<driver_name>[0-9A-Za-z\-_\.]+)/(?P<histotype_name>[0-9A-Za-z\_]+)/(?P<study_pmid>[0-9A-Za-z\_]+)/$', views.ajax_results_fast_minimal_data_version, name='get_dependencies'), # \_ needed to match ALL_STUDIES and ALL_HISTOTYPES
