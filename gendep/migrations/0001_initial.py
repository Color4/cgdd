# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-07 10:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('histotype', models.CharField(choices=[('BONE', 'Bone'), ('BREAST', 'Breast'), ('CENTRAL_NERVOUS_SYSTEM', 'CNS'), ('CERVICAL', 'Cervical'), ('ENDOMETRIUM', 'Endometrium'), ('HAEMATOPOIETIC_AND_LYMPHOID_TISSUE', 'Blood & Lymph'), ('HEADNECK', 'Head & Neck'), ('INTESTINE', 'Intestine'), ('KIDNEY', 'Kidney'), ('LARGE_INTESTINE', 'Large Intestine'), ('LUNG', 'Lung'), ('OESOPHAGUS', 'Esophagus'), ('OVARY', 'Ovary'), ('PANCREAS', 'Pancreas'), ('PLEURA', 'Pleura'), ('PROSTATE', 'Prostate'), ('SKIN', 'Skin'), ('SOFT_TISSUE', 'Soft tissue'), ('STOMACH', 'Stomach'), ('URINARY_TRACT', 'Urinary tract'), ('PANCAN', 'Pan cancer')], db_index=True, max_length=35, verbose_name='Histotype')),
