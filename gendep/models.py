...
class Gene(models.Model):
    ...
    # Removed these two columns as are combined into 'prevname_synonyms':
    # prev_names  = models.CharField('Previous name', max_length=100, blank=True) # Previous gene name(s)
    ...
    driver_num_studies = models.PositiveSmallIntegerField('Number of studies', default=0, blank=True) # smallinteger is 0 to 32767; cached number of studies that have this as a driver, generated by SQL query after loading data.
    driver_study_list = models.CharField('Tissues this driver has been tested on', max_length=250, blank=True) # alias_name (this should match the 'num_histotypes')

    driver_num_histotypes = models.PositiveSmallIntegerField('Number of histotypes for this driver', default=0, blank=True)
    driver_histotype_list = models.CharField('Tissues this driver has been tested on', max_length=250, blank=True) # alias_name (this should match the 'num_histotypes')
    ...
    target_num_histotypes = models.PositiveIntegerField('Number of histotypes for this target', default=0, blank=True) # positiveinteger 0 to 2147483647; cached number of targets, generated by SQL query after loading data.    
...
# No longer using the 'Drug' table, as jsut stoiring the list of drugs as text in the Gene table:
...
class Dependency(models.Model):
    ...
    # 'inhibitors' moved to the Gene table, and no longer using the 'Drug' table:
