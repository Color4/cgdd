...
if (isAchilles) {
  ...
  uv_results_kinome_combmuts_file <- "univariate_results_Achilles_v2_for_remaining_drivers_pancan_kinome_combmuts_180325_witheffectsize.txt"
  uv_results_kinome_combmuts_bytissue_file <- "univariate_results_Achilles_v2_for_remaining_drivers_bytissue_kinome_combmuts_180325_witheffectsize.txt"
